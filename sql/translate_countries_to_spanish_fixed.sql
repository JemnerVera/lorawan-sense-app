-- Script para traducir nombres de países al español (CORREGIDO)
...
-- Países de América del Norte (MANEJO ESPECIAL para códigos duplicados)
-- Estados Unidos y Canadá comparten +1, pero tienen códigos específicos
-- Solo actualizamos el registro principal de +1 (que debería ser Estados Unidos)
