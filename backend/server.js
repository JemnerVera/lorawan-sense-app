...
app.post('/api/auth/reset-password', async (req, res) => {
  try {
    ...
    console.log('🔐 Backend: Solicitando reset de contraseña para:', login);

    // Llamar a la función de PostgreSQL para reset de contraseña
    // La función se llama 'fn_reset_password' en el schema 'sense'
    ...
    console.log('✅ Reset de contraseña exitoso para:', login);
    res.json({ 
      success: true,
