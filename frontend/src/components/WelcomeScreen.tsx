...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onContinue }) => {
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center z-50 welcome-screen-enter">
      <div className="bg-gray-800 bg-opacity-90 backdrop-blur-sm rounded-2xl p-8 max-w-2xl mx-4 border border-gray-700 shadow-2xl">
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="bg-gray-700 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-400">Visualiza datos y métricas</p>
            </div>
            <div className="bg-gray-700 rounded-lg p-4">
              <div className="text-2xl mb-2">⚙️</div>
              <h3 className="font-semibold text-white mb-1">Parámetros</h3>
              <p className="text-sm text-gray-400">Gestiona configuraciones</p>
            </div>
            <div className="bg-gray-700 rounded-lg p-4">
              <div className="text-2xl mb-2">🔧</div>
              <h3 className="font-semibold text-white mb-1">Configuración</h3>
              <p className="text-sm text-gray-400">Ajusta preferencias</p>
            </div>
          </div>
