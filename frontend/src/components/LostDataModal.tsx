      ...
      <div className="bg-neutral-800 border border-orange-500 rounded-lg p-6 max-w-md mx-4">
        ...
        <div className="mb-6">
          <p className="text-white font-mono text-sm leading-relaxed">
            Tienes datos sin guardar en la pestaña <span className="text-orange-400 font-bold">{currentTab}</span>.
          </p>
          <p className="text-white font-mono text-sm leading-relaxed mt-2">
            Si cambias a <span className="text-orange-400 font-bold">{targetTab}</span>, se perderá toda la información ingresada.
          </p>
        </div>
        ...
        <div className="flex gap-3 justify-end">
          ...
          <button
            onClick={onConfirm}
            className="px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white font-mono tracking-wider rounded-lg transition-colors"
          >
            CONTINUAR
          </button>
        </div>
